...
def main():
    ...
    all_people_m1 = list(invitees)
    start_name = all_people_m1.pop()
    
    all_perms = itertools.permutations(all_people_m1)
    max_happiness = 0

    for perm in all_perms:
        cur_perm = list(perm)
        cur_perm.insert(0, start_name)
        cur_perm.append(start_name)
