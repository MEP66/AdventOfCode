def main():
    ...
    maxrow = list(originalinput.keys())[-1][0]
    maxcol = list(originalinput.keys())[-1][1]

    allresults = list()
    for col in range(1, maxcol+1):
        allresults.append(processit(((1, col), (1, 0))))
        allresults.append(processit(((maxrow, col), (-1, 0))))
    for row in range(1, maxrow+1):
        allresults.append(processit(((row, 1), (0, 1))))
        allresults.append(processit(((row, maxcol), (0, -1))))

    print('Final result = ', max(allresults))
