...
def move_it(coord_list, dir, fmap):
    ...
    for cur_col, cur_row in coord_list:
        ...
        match fmap[nbr_coord.r][nbr_coord.c]:
            ...
            case '[':
                if dir in ['^', 'v']:
                    nxt_lvl_coord_list = nxt_lvl_coord_list.union({nbr_coord, Coord(nbr_coord.c+1, nbr_coord.r)})
                elif dir == '>':
                    nxt_lvl_coord_list = {Coord(nbr_coord.c+1, nbr_coord.r)}
                else:
    ...
    if nxt_lvl_coord_list:
        move_it(nxt_lvl_coord_list, dir, fmap)
    for coord in coord_list:
        nbr_coord = Coord(coord.c + move_dir[dir].c, coord.r + move_dir[dir].r)
        fmap[nbr_coord.r][nbr_coord.c] = fmap[coord.r][coord.c]
        fmap[coord.r][coord.c] = '.'
        if dir == '<' and fmap[nbr_coord.r][nbr_coord.c] != '@':
            fmap[coord.r][coord.c] = ']'
            fmap[coord.r][coord.c+1] = '.'
        elif dir == '>' and fmap[nbr_coord.r][nbr_coord.c] != '@':
            fmap[coord.r][coord.c] = '['
            fmap[coord.r][coord.c-1] = '.'
    return nbr_coord
